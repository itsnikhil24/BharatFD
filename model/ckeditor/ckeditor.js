...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "O7L9", version: "4.25.0-lts", revision: "82796d03d0", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
        ...
        var a = {}; CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var b = CKEDITOR.event.prototype, c; for (c in b) null == a[c] && (a[c] = b[c]) }, CKEDITOR.event.prototype = function () {
            function d(a) { var e = b(this); return e[a] || (e[a] = new c(a)) } var b = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, c = function (a) { this.name = a; this.listeners = [] }; c.prototype = {
                ...
                define: function (a, b) { var c = d.call(this, a); CKEDITOR.tools.extend(c, b, !0) }, on: function (b, c, k, h, l) {
                    function q(x, y, A, l) { x = { name: b, sender: this, editor: x, data: y, listenerData: h, stop: A, cancel: l, removeListener: g }; return !1 === c.call(k, x) ? a : x.data } function g() { x.removeListener(b, c) } var x = this, y = d.call(this, b); if (0 > y.getListenerIndex(c)) {
                        y = y.listeners; k || (k = this); isNaN(l) && (l = 10); q.fn = c; q.priority = l; for (var A = y.length - 1; 0 <= A; A--)if (y[A].priority <= l) return y.splice(A + 1, 0, q), { removeListener: g };
                        y.unshift(q)
                    ...
                    var c = 0, e = function () { c = 1 }, d = 0, h = function () { d = 1 }; return function (l, q, g) {
                        var x = b(this)[l]; l = c; var y = d; c = d = 0; if (x) {
                            var A = x.listeners; if (A.length) for (var A = A.slice(0),
                                F, u = 0; u < A.length; u++) { if (x.errorProof) try { F = A[u].call(this, g, q, e, h) } catch (m) { } else F = A[u].call(this, g, q, e, h); F === a ? d = 1 : "undefined" != typeof F && (q = F); if (c || d) break }
                        } q = d ? !1 : "undefined" == typeof q ? !0 : q; c = l; d = y; return q
                    }
    ...
    (function () {
        function a(a, b, c) { this._minInterval = a; this._context = c; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(b, c || {}); var g = this; this.input = function () { function a() { g._lastOutput = (new Date).getTime(); g._scheduledTimer = 0; g._call() } if (!g._scheduledTimer || !1 !== g._reschedule()) { var x = (new Date).getTime() - g._lastOutput; x < g._minInterval ? g._scheduledTimer = setTimeout(a, g._minInterval - x) : a() } } } function d(x, b, c) {
            a.call(this, x, b, c); this._args = []; var g = this; this.input = CKEDITOR.tools.override(this.input,
                function (a) { return function () { g._args = Array.prototype.slice.call(arguments); a.call(this) } })
        } var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, e = />/g, k = /</g, h = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, q = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, g = function (a, b) { return "#" == b[0] ? String.fromCharCode(parseInt(b.slice(1), 10)) : q[b] }; CKEDITOR.on("reset", function () { b = [] }); CKEDITOR.tools = {
            arrayCompare: function (a, b) {
                ...
                return void 0 === a || null === a ? "" : String(a).replace(f, "\x26amp;").replace(e, "\x26gt;").replace(k,
                    "\x26lt;")
            }, htmlDecode: function (a) { return a.replace(l, g) }, htmlEncodeAttr: function (a) { return CKEDITOR.tools.htmlEncode(a).replace(h, "\x26quot;") }, htmlDecodeAttr: function (a) { return CKEDITOR.tools.htmlDecode(a) }, transformPlainTextToHtml: function (a, b) {
                var c = b == CKEDITOR.ENTER_BR, g = this.htmlEncode(a.replace(/\r\n/g, "\n")), g = g.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div"; if (!c) {
                    var m = /\n{2}/g; if (m.test(g)) var l = "\x3c" + h + "\x3e", e = "\x3c/" + h + "\x3e", g = l + g.replace(m, function () {
                        return e +
                            l
                    }) + e
            ...
            convertToPx: function () { var a, b; return function (c) { if (!a || a.isDetached()) a = CKEDITOR.dom.element.createFromHtml('\x3cdiv style\x3d"position:absolute;left:-9999px;top:-9999px;margin:0px;padding:0px;border:0px;"\x3e\x3c/div\x3e', CKEDITOR.document), CKEDITOR.document.getBody().append(a); if (!/%$/.test(c)) { var g = 0 > parseFloat(c); g && (c = c.replace("-", "")); a.setStyle("width", c); b = a.getClientRect(); c = Math.round(b.width); return g ? -c : c } return c } }(), repeat: function (a, b) { return Array(b + 1).join(a) }, tryThese: function () {
                ...
                b) { for (var c = 0, g = a.length; c < g; ++c)if (a[c].match(b)) return !0; return !1 }, checkIfAnyObjectPropertyMatches: function (a, b) { for (var c in a) if (c.match(b)) return !0; return !1 }, keystrokeToString: function (a, b) { var c = this.keystrokeToArray(a, b); c.display = c.display.join("+"); c.aria = c.aria.join("+"); return c }, keystrokeToArray: function (a, b) {
                    var c = b & 16711680, g = b & 65535, h = CKEDITOR.env.mac, m = [], l = []; c & CKEDITOR.CTRL && (m.push(h ? "⌘" : a[17]), l.push(h ? a[224] : a[17])); c & CKEDITOR.ALT && (m.push(h ? "⌥" : a[18]), l.push(a[18])); c & CKEDITOR.SHIFT &&
                        (m.push(h ? "⇧" : a[16]), l.push(a[16])); g && (a[g] ? (m.push(a[g]), l.push(a[g])) : (m.push(String.fromCharCode(g)), l.push(String.fromCharCode(g)))); return { display: m, aria: l }
            ...
            getMouseButton: function (a) { return (a = a && a.data ? a.data.$ : a) ? CKEDITOR.tools.normalizeMouseButton(a.button) : !1 }, normalizeMouseButton: function (a, b) { if (!CKEDITOR.env.ie || 9 <= CKEDITOR.env.version && !CKEDITOR.env.ie6Compat) return a; for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE, 4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], g = 0; g < c.length; g++) { var h = c[g]; if (h[0] === a && b) return h[1]; if (!b && h[1] === a) return h[0] } }, convertHexStringToBytes: function (a) {
                var b = [], c = a.length / 2, g; for (g = 0; g < c; g++)b.push(parseInt(a.substr(2 *
                    g, 2), 16)); return b
            }, convertBytesToBase64: function (a) { var b = "", c = a.length, g; for (g = 0; g < c; g += 3) { var h = a.slice(g, g + 3), m = h.length, l = [], e; if (3 > m) for (e = m; 3 > e; e++)h[e] = 0; l[0] = (h[0] & 252) >> 2; l[1] = (h[0] & 3) << 4 | h[1] >> 4; l[2] = (h[1] & 15) << 2 | (h[2] & 192) >> 6; l[3] = h[2] & 63; for (e = 0; 4 > e; e++)b = e <= m ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l[e]) : b + "\x3d" } return b }, style: {
                parse: {
            ...
            $: function (a) { a = a || {}; this.width = a.width; this.style = a.style; this.color = a.color; this._.normalize() }, _: {
                ...
                fromCssRule: function (a) {
                    ...
                    b = b || {}; var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (c, g) { var h = a["border-" + g] || b[g]; c[g] = h ? CKEDITOR.tools.style.parse.sideShorthand(h) : null; return c }, {}); return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, g) {
                        var h = {}, l; for (l in c) {
                            var e =
                                a["border-" + g + "-" + l]; h[l] = e ? e : c[l] && c[l][g]
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    function a(b, c, g) {
                        if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                            for (var h =
                                []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();)if (h.push(c), c = g ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return; if (b.isIdentical(c)) { for (var e = g ? b.getLast() : b.getFirst(); h.length;)h.shift().move(b, !g); c.moveChildren(b, !g); c.remove(); e && e.type == CKEDITOR.NODE_ELEMENT && e.mergeSiblings() }
                        }
                    ...
                    } function u(a, b) { var c = { x: 0, y: 0 }; if (!a.is(M ? "body" : "html")) { var g = a.$.getBoundingClientRect(); c.x = g.left; c.y = g.top } g = a.getWindow(); g.equals(b) || (g = u(CKEDITOR.dom.element.get(g.$.frameElement), b), c.x += g.x, c.y += g.y); return c } function m(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 } !a && (a = this.getWindow()); d = a.getDocument(); var M = "BackCompat" == d.$.compatMode; a instanceof CKEDITOR.dom.window && (a = M ? d.getBody() : d.getDocumentElement());
                    CKEDITOR.env.webkit && (d = this.getEditor(!1)) && (d._.previousScrollTop = null); d = a.getWindow(); e = u(this, d); var w = u(a, d), J = this.$.offsetHeight; g = this.$.offsetWidth; var G = a.$.clientHeight, p = a.$.clientWidth; d = e.x - m(this, "left") - w.x || 0; f = e.y - m(this, "top") - w.y || 0; g = e.x + g + m(this, "right") - (w.x + p) || 0; e = e.y + J + m(this, "bottom") - (w.y + G) || 0; (0 > f || 0 < e) && k(0, !0 === b ? f : !1 === b ? e : 0 > f ? f : e); c && (0 > d || 0 < g) && k(0 > d ? d : g, 0)
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (g) { var e, d; e = g && g.type != CKEDITOR.NODE_ELEMENT && (d = g.getParent()) && c(d); e = a ? e : e || c(g); return !!(b ^ e) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (g) { b(g) ? g = 1 : (g.type == CKEDITOR.NODE_TEXT && (g = g.getParent()), g = g.$.offsetWidth <= c); return !!(a ^ g) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                ...
                function (a) { return function (b) { b = e(b) || k(b) || h(b); return !!(a ^ b) } }; var q = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, g = b.getChildCount(); c < g; ++c)if (!q(b.getChild(c))) return !!a; return !a } }; var g = CKEDITOR.dom.walker.empty(), x = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && g(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, e, d) {
            function f(a, b, c, g) { var Q = c ? a.getPrevious() : a.getNext(); if (g && k) return Q; q || g ? b.append(a.clone(!0, d), c) : (a.remove(), l && b.append(a, c)); return Q } function m() { var a, b, c, g = Math.min(L.length, r.length); for (a = 0; a < g; a++)if (b = L[a], c = r[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = I - 1, c = z && E && !p.equals(v); b < N - 1 || b < n - 1 || c ? (c ? a.moveToPosition(v,
                    CKEDITOR.POSITION_BEFORE_START) : n == b + 1 && t ? a.moveToPosition(r[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(r[b + 1], CKEDITOR.POSITION_BEFORE_START), e && (b = L[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({ startNode: c }))) : a.collapse(!0)
            } a.optimizeBookmark(); var k = 0 === b, l = 1 == b, q = 2 == b; b = q || l; var p = a.startContainer, v = a.endContainer,
                K = a.startOffset, D = a.endOffset, B, t, z, E, H, S; if (q && v.type == CKEDITOR.NODE_TEXT && (p.equals(v) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(v))) c.append(a.document.createText(v.substring(K, D))); else {
                    v.type == CKEDITOR.NODE_TEXT ? q ? S = !0 : v = v.split(D) : 0 < v.getChildCount() ? D >= v.getChildCount() ? (v = v.getChild(D - 1), t = !0) : v = v.getChild(D) : E = t = !0; p.type == CKEDITOR.NODE_TEXT ? q ? H = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), B = !0) : p = p.getChild(K - 1) : z = B = !0; for (var L = p.getParents(), r = v.getParents(), I = m(),
                        N = L.length - 1, n = r.length - 1, C = c, Q, Z, W, da = -1, U = I; U <= N; U++) { Z = L[U]; W = Z.getNext(); for (U != N || Z.equals(r[U]) && N < n ? b && (Q = C.append(Z.clone(0, d))) : B ? f(Z, C, !1, z) : H && C.append(a.document.createText(Z.substring(K))); W;) { if (W.equals(r[U])) { da = U; break } W = f(W, C) } C = Q } C = c; for (U = I; U <= n; U++)if (c = r[U], W = c.getPrevious(), c.equals(L[U])) b && (C = C.getChild(0)); else { U != n || c.equals(L[U]) && n < N ? b && (Q = C.append(c.clone(0, d))) : t ? f(c, C, !1, E) : S && C.append(a.document.createText(c.substring(0, D))); if (U > da) for (; W;)W = f(W, C, !0); C = Q } q || h()
                }
        }
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && q(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var e = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), q = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function a(b) {
                    ...
                    var e = this.collapsed, d = { container: this.startContainer, offset: this.startOffset }, f = { container: this.endContainer, offset: this.endOffset }; c && (a(d), b(d, this.root),
                        e || (a(f), b(f, this.root))); return { start: d.container.getAddress(c), end: e ? null : f.container.getAddress(c), startOffset: d.offset, endOffset: f.offset, normalized: c, collapsed: e, is2: !0 }
                }
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } function e(a, b, c) {
                    ...
                    case CKEDITOR.ENLARGE_INLINE: var h = 1; case CKEDITOR.ENLARGE_ELEMENT: if (this.collapsed) break; var k = this.getCommonAncestor(); m = this.root; var l, q, p, v, K, D = !1, B; B = this.startContainer; var t = this.startOffset; B.type == CKEDITOR.NODE_TEXT ? (t && (B = !CKEDITOR.tools.trim(B.substring(0, t)).length && B, D = !!B), B && ((v = B.getPrevious()) || (p = B.getParent()))) : (t && (v = B.getChild(t - 1) || B.getLast()), v || (p = B)); for (p = c(p); p ||
                        v;) {
                            if (p && !v) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !m.contains(p)) break; D && "inline" == p.getComputedStyle("display") || (D = !1, K ? l = p : this.setStartBefore(p)); v = p.getPrevious() } for (; v;)if (B = !1, v.type == CKEDITOR.NODE_COMMENT) v = v.getPrevious(); else {
                                if (v.type == CKEDITOR.NODE_TEXT) f = v.getText(), d.test(f) && (v = null), B = /[\s\ufeff]$/.test(f); else if ((v.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && v.is("br")) && !v.data("cke-bookmark")) if (D && CKEDITOR.dtd.$removeEmpty[v.getName()]) {
                                    f = v.getText(); if (d.test(f)) v =
                                        null; else for (var t = v.$.getElementsByTagName("*"), z = 0, E; E = t[z++];)if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) { v = null; break } v && (B = !!f.length)
                                } else v = null; B && (D ? K ? l = p : p && this.setStartBefore(p) : D = !0); if (v) { B = v.getPrevious(); if (!p && !B) { p = v; v = null; break } v = B } else p = null
                            } p && (p = c(p.getParent()))
                    } B = this.endContainer; t = this.endOffset; p = v = null; K = D = !1; B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(t)).length ? D = !0 : (D = !B.getLength(), t == B.getLength() ? (v = B.getNext()) || (p = B.getParent()) : e(B,
                        t, m) && (p = B.getParent())) : (v = B.getChild(t)) || (p = B); for (; p || v;) {
                            if (p && !v) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !m.contains(p)) break; D && "inline" == p.getComputedStyle("display") || (D = !1, K ? q = p : p && this.setEndAfter(p)); v = p.getNext() } for (; v;) {
                                B = !1; if (v.type == CKEDITOR.NODE_TEXT) f = v.getText(), e(v, 0, m) || (v = null), B = /^[\s\ufeff]/.test(f); else if (v.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < v.$.offsetWidth || b && v.is("br")) && !v.data("cke-bookmark")) if (D && CKEDITOR.dtd.$removeEmpty[v.getName()]) {
                                        f = v.getText(); if (d.test(f)) v =
                                            null; else for (t = v.$.getElementsByTagName("*"), z = 0; E = t[z++];)if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) { v = null; break } v && (B = !!f.length)
                                    } else v = null
                                } else B = 1; B && D && (K ? q = p : this.setEndAfter(p)); if (v) { B = v.getNext(); if (!p && !B) { p = v; v = null; break } v = B } else p = null
                            } p && (p = c(p.getParent()))
                        } l && q && (k = l.contains(q) ? q : l, this.setStartBefore(k), this.setEndAfter(k)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: p = new CKEDITOR.dom.range(this.root); m = this.root; p.setStartAt(m,
                            CKEDITOR.POSITION_AFTER_START); p.setEnd(this.startContainer, this.startOffset); p = new CKEDITOR.dom.walker(p); var H, S, L = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), r = null, I = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (r) { if (r.equals(a)) { r = null; return } } else r = a; else if (r) return; var b = L(a); b || (H = a); return b }, h = function (a) { var b = I(a); !b && a.is && a.is("br") && (S = a); return b }; p.guard = I; p = p.lastBackward(); H = H || m; this.setStartAt(H,
                                !H.is("br") && (!p && this.checkStartOfBlock() || p && H.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { p = this.clone(); p = new CKEDITOR.dom.walker(p); var N = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(); p.evaluator = function (a) { return !N(a) && !n(a) }; if ((p = p.previous()) && p.type == CKEDITOR.NODE_ELEMENT && p.is("br")) break } p = this.clone(); p.collapse(); p.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); p = new CKEDITOR.dom.walker(p); p.guard =
                                    a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? h : I; H = r = S = null; p = p.lastForward(); H = H || m; this.setEndAt(H, !p && this.checkEndOfBlock() || p && H.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); S && this.setEndAfter(S)
                }
                ...
                var e = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, d = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var f = this.clone(), m = this.startContainer, h = this.endContainer, k = this.startOffset, l = this.endOffset,
                        q = c = 1; m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength() ? f.setStartAfter(m) : (f.setStartBefore(m), c = 0) : f.setStartBefore(m)); h && h.type == CKEDITOR.NODE_TEXT && (l ? l >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), q = 0) : f.setEndBefore(h)); var f = new CKEDITOR.dom.walker(f), p = CKEDITOR.dom.walker.bookmark(), v = CKEDITOR.dom.walker.bogus(); f.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var K; f.guard = function (b, c) {
                            if (d && v(b) || p(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT &&
                ...
                b) { var c = this.createBookmark(), e = this.document.createElement(b); this.collapse(a); this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS); this.extractContents().appendTo(e); e.trim(); this.insertNode(e); var d = e.getBogus(); d && d.remove(); e.appendBogus(); this.moveToBookmark(c); return e }, splitBlock: function (a, b) {
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
                        !0; for (var c = 0; a;) {
                            ...
                            else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block)) return this.setStartBefore(a), this.setEndAfter(a), !0; var e = a, d = c, f = void 0; e.type == CKEDITOR.NODE_ELEMENT && e.isEditable(!1) && (f = e[b ? "getLast" : "getFirst"](q)); d || f || (f = e[b ? "getPrevious" : "getNext"](q)); a = f
                        } return !!c
            ...
            h = function (a) { return e(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, y, A, F; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var M = 0, w = m.hasAscendant("pre"), J = m.type != CKEDITOR.NODE_ELEMENT, G = 0; if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0); else {
                            var p = m.getName();
                            if (CKEDITOR.dtd.$block[p] && "false" == m.getAttribute("contenteditable")) { d = m; b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if ("br" == p) J = 1; else if (!k && !m.getChildCount() && "hr" != p) { d = m; y = m.equals(u); break } k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = m)); M = 1 } else { if (m.getFirst()) { k || (k = this.range.clone(), k.setStartAt(m, CKEDITOR.POSITION_BEFORE_START)); m = m.getFirst(); continue } J = 1 }
                        } J && !k && (k = this.range.clone(), k.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                        y = (!M || J) && m.equals(u); if (k && !M) for (; !m.getNext(h) && !y;) { p = m.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { M = 1; J = 0; y || p.equals(u); k.setEndAt(p, CKEDITOR.POSITION_BEFORE_END); break } m = p; J = 1; y = m.equals(u); G = 1 } J && k.setEndAt(m, CKEDITOR.POSITION_AFTER_END); m = this._getNextSourceNode(m, G, u); if ((y = !m) || M && k) break
                    } if (!d) {
                        ...
                        d = d.block; !d && m && !this.enforceRealBlocks && M[m.getName()] && k.checkStartOfBlock() && k.checkEndOfBlock() && !m.equals(k.root) ? d = m : !d || this.enforceRealBlocks && d.is(l) ? (d = this.range.document.createElement(a), k.extractContents().appendTo(d), d.trim(), k.insertNode(d), A = F = !0) : "li" != d.getName() ? k.checkStartOfBlock() && k.checkEndOfBlock() || (d = d.clone(!1), k.extractContents().appendTo(d), d.trim(), F = k.splitBlock(), A = !F.wasStartOfBlock, F = !F.wasEndOfBlock, k.insertNode(d)) : y || (this._.nextNode = d.equals(u) ? null : this._getNextSourceNode(k.getBoundaryNodes().endNode,
                            1, u))
                    } A && (A = d.getPrevious()) && A.type == CKEDITOR.NODE_ELEMENT && ("br" == A.getName() ? A.remove() : A.getLast() && "br" == A.getLast().$.nodeName.toLowerCase() && A.getLast().remove()); F && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(e) || A.getNext(e)) && A.remove(); this._.nextNode || (this._.nextNode = y || d.equals(u) || !u ? null : this._getNextSourceNode(d, 1, u)); return d
    ...
    (function () {
        function a(a, b, c, e, d) {
            var f, g; a = []; for (f in b) {
                g = b[f]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : z(g); "$" != f.charAt(0) && (g.elements = f); c && (g.featureName = c.toLowerCase()); var n = g; n.elements = k(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var t = /\s*,\s*/, r = void 0; for (r in S) {
                    n[r] = k(n[r], t) || null; var E = n, m = L[r], h = k(n[L[r]], t), D = n[r], C = [], H = !0, I = void 0; h ? H = !1 : h = {}; for (I in D) "!" == I.charAt(0) && (I = I.slice(1), C.push(I), h[I] = !0, H = !1); for (; I = C.pop();)D[I] = D["!" +
                        I], delete D["!" + I]; E[m] = (H ? !1 : h) || null
                } n.match = n.match || null; e.push(g); a.push(g)
            } b = d.elements; d = d.generic; var B; c = 0; for (e = a.length; c < e; ++c) {
                f = z(a[c]); g = !0 === f.classes || !0 === f.styles || !0 === f.attributes; n = f; r = m = t = void 0; for (t in S) n[t] = M(n[t]); E = !0; for (r in L) { t = L[r]; m = n[t]; h = []; D = void 0; for (D in m) -1 < D.indexOf("*") ? h.push(new RegExp("^" + D.replace(/\*/g, ".*") + "$")) : h.push(D); m = h; m.length && (n[t] = m, E = !1) } n.nothingRequired = E; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === f.elements || null ===
                    f.elements) d[g ? "unshift" : "push"](f); else for (B in n = f.elements, delete f.elements, n) if (b[B]) b[B][g ? "unshift" : "push"](f); else b[B] = [f]
            }
        } function d(a, c, e, d) {
            if (!a.match || a.match(c)) if (d || h(a, c)) if (a.propertiesOnly || (e.valid = !0), e.allAttributes || (e.allAttributes = b(a.attributes, c.attributes, e.validAttributes)), e.allStyles || (e.allStyles = b(a.styles, c.styles, e.validStyles)), !e.allClasses) {
                a = a.classes; c = c.classes; d = e.validClasses; if (a) if (!0 === a) a = !0; else {
                    for (var f = 0, g = c.length, n; f < g; ++f)n = c[f], d[n] || (d[n] =
                        a(n)); a = !1
            ...
            b) { if (!a) return !1; var c = !1, e = !0 === a, d; for (d in b) if (e || a(d)) delete b[d], c = !0; return c } function e(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = E(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, e = 0, d; for (d in a) c[d] = a[d], e++; return e ? c : !1 } function h(a, b) {
                if (a.nothingRequired) return !0;
                var c, e, d, f; if (d = a.requiredClasses) for (f = b.classes, c = 0; c < d.length; ++c)if (e = d[c], "string" == typeof e) { if (-1 == CKEDITOR.tools.indexOf(f, e)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(f, e)) return !1; return l(b.styles, a.requiredStyles) && l(b.attributes, a.requiredAttributes)
            ...
            } function g(a) { var b, c, e, d, f = {}, g = 1; for (a = E(a); b = a.match(r);)(c = b[2]) ? (e = x(c, "styles"), d = x(c, "attrs"), c = x(c, "classes")) : e = d = c = null, f["$" + g++] = { elements: b[1], classes: c, styles: e, attributes: d }, a = a.slice(b[0].length); return f } function x(a, b) { var c = a.match(I[b]); return c ? E(c[1]) : null } function y(a) {
                ...
                var g = 0, t; f.toHtml && (b.name = b.name.replace(N, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { t = a.elementCallbacks; for (var r = 0, k = t.length, E; r < k; ++r)if (E = t[r](b)) { t = E; break a } t = void 0 } if (t) return t } if (f.doTransform && (t = a._.transformations[b.name])) { y(b); for (r = 0; r < t.length; ++r)p(a, b, t[r]); u(b) } if (f.doFilter) {
                    a: {
                        r = b.name; k = a._; a = k.allowedRules.elements[r]; t = k.allowedRules.generic; r = k.disallowedRules.elements[r]; k = k.disallowedRules.generic;
                        E = f.skipRequired; var h = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, z, D; if (a || t) { y(b); if (r) for (z = 0, D = r.length; z < D; ++z)if (!1 === c(r[z], b, h)) { a = null; break a } if (k) for (z = 0, D = k.length; z < D; ++z)c(k[z], b, h); if (a) for (z = 0, D = a.length; z < D; ++z)d(a[z], b, h, E); if (t) for (z = 0, D = t.length; z < D; ++z)d(t[z], b, h, E); a = h } else a = null
                    } if (!a || !a.valid) return e.push(b), 1; D = a.validAttributes; var C = a.validStyles;
                    t = a.validClasses; var r = b.attributes, H = b.styles, k = b.classes; E = b.classBackup; var L = b.styleBackup, I, B, l = [], h = [], S = /^data-cke-/; z = !1; delete r.style; delete r["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (I in r) D[I] || (S.test(I) ? I == (B = I.replace(/^data-cke-saved-/, "")) || D[B] || (delete r[I], z = !0) : (delete r[I], z = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (I in H) a.allStyles || C[I] ? l.push(I + ":" + H[I]) : z = !0; l.length && (r.style = l.sort().join("; ")) } else L && (r.style = L); if (!a.allClasses ||
                        a.hadInvalidClass) { for (I = 0; I < k.length; ++I)(a.allClasses || t[k[I]]) && h.push(k[I]); h.length && (r["class"] = h.sort().join(" ")); E && h.length < E.split(/\s+/).length && (z = !0) } else E && (r["class"] = E); z && (g = 1); if (!f.skipFinalValidation && !m(b)) return e.push(b), 1
                ...
                var e = a.name; if (t.$empty[e] || !a.children.length) "hr" == e && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (t.$block[e] || "tr" == e) if ("br" == b) a.previous && !J(a.previous) && (b = w(), b.insertBefore(a)), a.next && !J(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var e = a.children, d; b: { d = t[b]; for (var f = 0, g = e.length, n; f < g; ++f)if (n = e[f], n.type == CKEDITOR.NODE_ELEMENT && !d[n.name]) { d = !1; break b } d = !0 } if (d) a.name = b, a.attributes =
                        {}, c.push({ check: "parent-down", el: a }); else { d = a.parent; for (var f = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == d.name, r, k, g = e.length; 0 < g;)n = e[--g], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && t.$inline[n.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({ check: "parent-down", el: r })), r.add(n, 0)) : (r = null, k = t[d.name] || t.span, n.insertAfter(a), d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || k[n.name] || c.push({ check: "el-up", el: n })); a.remove() }
                } else e in
                    { style: 1, script: 1 } ? a.remove() : (a.parent && c.push({ check: "it", el: a.parent }), a.replaceWithChildren())
            } function p(a, b, c) { var e, d; for (e = 0; e < c.length; ++e)if (d = c[e], !(d.check && !a.check(d.check, !1) || d.left && !d.left(b))) { d.right(b, C); break } } function v(a, b) {
                var c = b.getDefinition(), e = c.attributes, d = c.styles, f, g, n, t; if (a.name != c.element) return !1; for (f in e) if ("class" == f) for (c = e[f].split(/\s+/), n = a.classes.join("|"); t = c.pop();) { if (-1 == n.indexOf(t)) return !1 } else if (a.attributes[f] != e[f]) return !1; for (g in d) if (a.styles[g] !=
                    d[g]) return !1; return !0
            } function K(a, b) { var c, e; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? e = a : (c = a[0], e = a[1]); return [{ element: c, left: e, right: function (a, c) { c.transform(a, b) } }] } function D(a) { return function (b) { return v(b, a) } } function B(a) { return function (b, c) { c[a](b) } } var t = CKEDITOR.dtd, z = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, H = ["", "p", "br", "div"]; CKEDITOR.FILTER_SKIP_TREE = 2; CKEDITOR.filter = function (a, b) {
                this.allowedContent = []; this.disallowedContent = []; this.elementCallbacks = null; this.disabled =
                    !1; this.editor = null; this.id = CKEDITOR.tools.getNextNumber(); this._ = { allowedRules: { elements: {}, generic: [] }, disallowedRules: { elements: {}, generic: [] }, transformations: {}, cachedTests: {}, cachedChecks: {} }; CKEDITOR.filter.instances[this.id] = this; var c = this.editor = a instanceof CKEDITOR.editor ? a : null; if (c && !b) {
                        this.customConfig = !0; var e = c.config.allowedContent; !0 === e ? this.disabled = !0 : (e || (this.customConfig = !1), this.allow(e, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(H[c.enterMode] +
                ...
                allow: function (b, c, d) {
                    if (!e(this, b, d)) return !1; var f, n; if ("string" == typeof b) b = g(b); else if (b instanceof CKEDITOR.style) {
                        ...
                        d && (d = z(d), f.classes = d["class"] ? d["class"].split(/\s+/) : null, f.requiredClasses = f.classes, delete d["class"], f.attributes = d, f.requiredAttributes = d && CKEDITOR.tools.object.keys(d))
                    ...
                    if (this.disabled) return !1; var d = this, f = [], g = this.editor && this.editor.config.protectedSource, n, r = !1, k = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (n = A(d, a, f, k), n & 1) r = !0; else if (n & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var e = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var t, E, z; if (g) for (E = 0; E < g.length; ++E)if ((z = e.match(g[E])) && z[0].length == e.length) {
                                    c =
                                    !0; break a
                                } e = CKEDITOR.htmlParser.fragment.fromHtml(e); 1 == e.children.length && (t = e.children[0]).type == CKEDITOR.NODE_ELEMENT && A(d, t, c, k); c = !c.length
                            } c || f.push(a)
                        }
                    }, null, !0); f.length && (r = !0); var E; a = []; e = H[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var z; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? G(c, e, a) : c.remove(); for (; E = a.pop();)if (c = E.el, c.parent) switch (z = t[c.parent.name] || t.span, E.check) {
                        case "it": t.$removeEmpty[c.name] && !c.children.length ? G(c, e, a) : m(c) || G(c, e, a); break; case "el-up": c.parent.type ==
                            CKEDITOR.NODE_DOCUMENT_FRAGMENT || z[c.name] || G(c, e, a); break; case "parent-down": c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || z[c.name] || G(c.parent, e, a)
                    }return r
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, e = [], d; for (b = 0; b < a.length && !d; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (d = c); if (d) { for (b = 0; b < a.length; ++b)e.push(K(a[b], d)); this.addTransformations(e) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var e = this._.transformations, d; for (d = 0; d < a.length; ++d) {
                            b = a[d]; var f = void 0, g = void 0, n = void 0, t = void 0, r = void 0, k = void 0; c = []; for (g = 0; g < b.length; ++g)n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), t = n[0], r = null, k = n[1]) : (t = n.check, r = n.left, k = n.right), f || (f = n, f = f.element ? f.element : t ? t.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), r instanceof CKEDITOR.style && (r = D(r)), c.push({ check: t == f ? null : t, left: r, right: "string" == typeof k ? B(k) : k }); b = f; e[b] || (e[b] = []); e[b].push(c)
                        }
                    }
                    ...
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var e = a.length; e--;)if (this.check(a[e], b, c)) return !0; return !1 } var d, f; if ("string" == typeof a) {
                        f = a + "\x3c" + (!1 === b ? "0" : "1") + (c ? "1" : "0") + "\x3e"; if (f in this._.cachedChecks) return this._.cachedChecks[f]; d = g(a).$1; var n = d.styles, e = d.classes; d.name = d.elements;
                    ...
                    } else d = a.getDefinition(), n = d.styles, e = d.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = z(n), e.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, d = { name: d.element, attributes: e, classes: e["class"] ? e["class"].split(/\s+/) : [], styles: n, children: [] }; var n = CKEDITOR.tools.clone(d), t = [], r; if (!1 !== b && (r = this._.transformations[d.name])) {
                        for (e =
                            0; e < r.length; ++e)p(this, d, r[e]); u(d)
                    } A(this, n, t, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < t.length ? c = !1 : ((b = d.attributes["class"]) && (d.attributes["class"] = d.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(d.attributes, n.attributes, !0), b && (d.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[f] = c); return c
                }, getAllowedEnterMode: function () {
                    var a = ["p", "div", "br"], b = { p: CKEDITOR.ENTER_P, div: CKEDITOR.ENTER_DIV, br: CKEDITOR.ENTER_BR };
                    return function (c, e) { var d = a.slice(), f; if (this.check(H[c])) return c; for (e || (d = d.reverse()); f = d.pop();)if (this.check(f)) return b[f]; return CKEDITOR.ENTER_BR }
            ...
            }; var S = { styles: 1, attributes: 1, classes: 1 }, L = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, r = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, N = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, C; C = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), e = c.styles, d = c.attributes, f, g, n, t; a.name = c.element; for (f in d) if ("class" ==
                            f) for (c = a.classes.join("|"), n = d[f].split(/\s+/); t = n.pop();)-1 == c.indexOf(t) && a.classes.push(t); else a.attributes[f] = d[f]; for (g in e) a.styles[g] = e[g]
                    }
                }
            }
    })();
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, f, e) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var h = b.length, l = h, q = [], g = [], x = function (a) { c && (k ? c.call(f, a) : c.call(f, q, g)) }; if (0 === l) x(!0); else {
                    var y = function (a, b) { (b ? q : g).push(a); 0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b)) }, A = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, F = function (b) {
                        if (a[b]) y(b, !0); else {
    ...
    (function () {
        ...
        } function e(a, b, c) { if (b) { var e, d, f = a.commands; for (d in f) e = f[d], (c || e.contextSensitive) && e.refresh(a, b) } } function k(a) { var b = a.config.customConfig; if (!b) return !1; var b = CKEDITOR.getUrl(b), c = u[b] || (u[b] = {}); c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && k(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function () { c.fn = c.fn || CKEDITOR.editorConfig || function () { }; k(a) }); return !0 } function h(a, b) {
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function () { q(a) }) } function q(a) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, e = b(c.plugins), d = b(c.extraPlugins), f = b(c.removePlugins); if (d) var g = new RegExp("(?:^|,)(?:" + d.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), e = e.replace(g, ""), e = e + ("," + d); if (f) var k = new RegExp("(?:^|,)(?:" +
                f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), e = e.replace(k, ""); CKEDITOR.env.air && (e += ",adobeair"); CKEDITOR.plugins.load(e.split(","), function (b) {
                    var e = [], d = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        var h = b[g], l = h.lang, L = null, r = h.requires, I; CKEDITOR.tools.isArray(r) && (r = r.join(",")); if (r && (I = r.match(k))) for (; r = I.pop();)CKEDITOR.error("editor-plugin-required", { plugin: r.replace(",", ""), requiredBy: g }); l && !a.lang[g] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ?
                            L = a.langCode : (L = a.langCode.replace(/-.*/, ""), L = L != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, L) ? L : 0 <= CKEDITOR.tools.indexOf(l, "en") ? "en" : l[0]), h.langEntries && h.langEntries[L] ? (a.lang[g] = h.langEntries[L], L = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + L + ".js"))); d.push(L); e.push(h)
            ...
            function c(a) { var b = a.startContainer, e = a.endContainer, d = b.is && b.is("tr"), f = b.is && b.is("td"); a = f && b.equals(e) && a.endOffset === b.getChildCount(); b = f && 1 === b.getChildCount() && "img" === b.getChildren().getItem(0).getName(); return d || a && !b ? !0 : !1 } function e(a) { var b = a.startContainer; return b.is("tr") ? a.cloneContents() : b.clone(!0) } for (var d = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                var B = a[h], t = B.startContainer.getAscendant("tr",
                    !0); c(B) ? (f || (f = t.getAscendant("table").clone(), f.append(t.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), d.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(t) || (g = t, k = t.clone(), f.append(k)), k.append(e(B))) : d.append(B.cloneContents())
        ...
        var a = /([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g, d = { checked: 1, compact: 1, declare: 1, defer: 1, disabled: 1, ismap: 1, multiple: 1, nohref: 1, noresize: 1, noshade: 1, nowrap: 1, readonly: 1, selected: 1 }; CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () { }, onTagClose: function () { }, onText: function () { }, onCDATA: function () { }, onComment: function () { }, parse: function (b) {
                for (var c, f, e = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    f = c.index; f > e && (e = b.substring(e, f), this.onText(e)); e = this._.htmlPartsRegex.lastIndex;
                    if (f = c[1]) if (f = f.toLowerCase(), k && CKEDITOR.dtd.$cdata[f] && (this.onCDATA(k), k = null), !k) { this.onTagClose(f); continue } if (f = c[3]) {
                        if (f = f.toLowerCase(), !/="/.test(f)) {
                            var h = {}, l, q = c[4]; c = !!c[5]; if (q) for (; l = a.exec(q);) { var g = l[1].toLowerCase(); l = l[2] || l[3] || l[4] || ""; h[g] = !l && d[g] ? g : CKEDITOR.tools.htmlDecodeAttr(l) } this.onTagOpen(f, h, c); CKEDITOR.dtd.$cdata[f] && (f = new RegExp("\x3c/" + f + "\x3e", "i"), k = b.substring(e), f = k.search(f), -1 === f && (f = k.length), k = k.substring(0, f), this._.htmlPartsRegex.lastIndex = e + k.length,
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (e, k, h) {
                function l(a) { var b; if (0 < m.length) for (var c = 0; c < m.length; c++) { var e = m[c], d = e.name, f = CKEDITOR.dtd[d], g = w.name && CKEDITOR.dtd[w.name]; g && !g[d] || a && f && !f[a] && CKEDITOR.dtd[a] ? d == w.name && (x(w, w.parent, 1), c--) : (b || (q(), b = 1), e = e.clone(), e.parent = w, w = e, m.splice(c, 1), c--) } } function q() { for (; M.length;)x(M.shift(), w) } function g(a) {
                ...
                } function x(b, c, e) { c = c || w || u; var d = w; void 0 === b.previous && (y(c, b) && (w = c, F.onTagOpen(h, {}), b.returnPoint = c = w), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (G = !1), "textarea" == b.name && (J = !1)); b.returnPoint ? (w = b.returnPoint, delete b.returnPoint) : w = e ? c : d } function y(a, b) {
                    ...
                    if (a(f)) m.push(f); else {
                        if ("pre" == e) G = !0; else { if ("br" == e && G) { w.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) } if ("br" == e) M.push(f); else {
                            for (; !(k = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || k[e]);)if (w.isOptionalClose) F.onTagClose(g); else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(w), w.parent) x(w, w.parent, 1); else { f.isOrphan = 1; break } l(e); q(); f.parent = w; f.isEmpty ? x(f) : w = f
                        }
                    }
                }; F.onTagClose = function (a) {
                    for (var b = m.length - 1; 0 <= b; b--)if (a == m[b].name) { m.splice(b, 1); return } for (var c = [], e = [], d = w; d != u && d.name != a;)d._.isBlockLike || e.unshift(d), c.push(d), d = d.returnPoint || d.parent; if (d != u) {
                        for (b = 0; b < c.length; b++) { var f = c[b]; x(f, f.parent) } w =
                            d; d._.isBlockLike ? q() : (b = CKEDITOR.config.shiftLineBreaks, !0 !== b && M.length && ("function" !== typeof b ? q() : (b = b(M[M.length - 1]), !0 !== b && (q(), b instanceof CKEDITOR.htmlParser.text && w.add(b), b instanceof CKEDITOR.htmlParser.element && x(b, w))))); x(d, d.parent); d == w && (w = w.parent); m = m.concat(e)
                    } "body" == a && (h = !1)
                }; F.onText = function (a) {
                    if (!(w._.hasInlineStarted && !M.length || G || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = w.name, e = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) :
                        c; if (!J && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a); else { q(); l(); G || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (y(w, a)) this.onTagOpen(h, {}, 0, 1); w.add(a) }
                }; F.onCDATA = function (a) { w.add(new CKEDITOR.htmlParser.cdata(a)) }; F.onComment = function (a) { q(); l(); w.add(new CKEDITOR.htmlParser.comment(a)) }; F.parse(e); for (q(); w != u;)x(w, w.parent, 1); g(u); return u
        ...
        function a() { this.rules = [] } function d(b, c, d, e) { var k, h; for (k in c) (h = b[k]) || (h = b[k] = new a), h.add(c[k], d, e) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++)e.push({ value: a[k], priority: c, options: d }); this.rules.splice.apply(this.rules, e) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, l, q, g, x; for (x = 0; x < h; x++)if (d && (l = c.type, q = c.name), g = k[x], !(a.nonEditable && !g.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            function g(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function t(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var n = [], t = b(f), h, k; if (t) for (r(t, 1) && n.push(t); t;)e(t) && (h = c(t)) && r(h) && ((k = c(h)) && !e(k) ? n.push(h) : (g(z).insertAfter(h), h.remove())), t = t.previous; for (t = 0; t < n.length; t++)n[t].remove(); if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) z || CKEDITOR.env.needsBrFiller ||
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? z || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (n = b(f), n = !n || "form" == f.name && "input" == n.name) : n = !1 : n = !1; n && f.add(g(a))
                    }
                }
            } function r(a, b) {
                if ((!z || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"]) return !0; var c; return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(M)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a),
                    a.value = c[0]), !CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in E) || !z && ((c = a.previous) && "br" == c.name || !c || e(c))) ? !0 : !1
            } var h = { elements: {} }, z = "html" == d, E = CKEDITOR.tools.extend({}, p), D; for (D in E) "#" in J[D] || delete E[D]; for (D in E) h.elements[D] = t(z, a.config.fillEmptyBlocks); h.root = t(z, !1); h.elements.br = function (a) {
                return function (b) {
            ...
            return a.replace(t,
                function (a, c, d) { return "\x3c" + c + d.replace(z, function (a, c) { return E.test(c) && -1 == d.indexOf("data-cke-saved-" + c) ? " data-cke-saved-" + a + " data-cke-" + b + "-" + a : a }) + "\x3e" })
        } function g(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + A(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(L, function (a, b) { return decodeURIComponent(b) }) } function y(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + w + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function A(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function F(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function u(a, b, c) {
            ...
            function (b) {
                var c, e, f = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = e = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(v); c.addRules(K, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); e.addRules(D); e.addRules(B, { applyToAll: !0 }); e.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                    ...
                    a.data.dataValue.filterChildren(f.htmlFilter,
                        !0)
                }, null, null, 10); b.on("toDataFormat", function (a) { a.data.filter.applyTo(a.data.dataValue, !1, !0) }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, e = f.writer; e.reset(); c.writeChildrenHtml(e); c = e.getHtml(!0); c = A(c); c = F(c, b); a.data.dataValue = c }, null, null, 15)
                ...
                }, toDataFormat: function (a, b) { var c, e, d; b && (c = b.context, e = b.filter, d = b.enterMode); c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: e || this.editor.filter, context: c, enterMode: d || this.editor.enterMode }).dataValue }, protectSource: function (a) { return u(a, this.editor) }, unprotectSource: function (a) {
                    return F(a,
                        this.editor)
                }, unprotectRealComments: function (a) { return A(a) }
            }; var M = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", J = CKEDITOR.dtd, G = "caption colgroup col thead tfoot tbody".split(" "), p = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block), v = { elements: { input: h, textarea: h } }, K = {
            ...
            }; CKEDITOR.env.ie && (B.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var t = /<(a|area|img|input|source)\b([^>]*)>/gi, z = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, E = /^(href|src|name)$/i, H = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, S = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
                L = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, r = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi; m = function () {
        ...
        function a(a) { return function (b) { return b.type == CKEDITOR.NODE_ELEMENT && ("string" == typeof a ? b.name == a : b.name in a) } } var d = function (a, b) { a = a[0]; b = b[0]; return a < b ? -1 : a > b ? 1 : 0 }, b = CKEDITOR.htmlParser.fragment.prototype; CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () { return new CKEDITOR.htmlParser.element(this.name, this.attributes) }, filter: function (a, b) {
                var e = this, d, h; b = e.getFilterContext(b); if (!e.parent) a.onRoot(b,
                    e); for (; ;) { d = e.name; if (!(h = a.onElementName(b, d))) return this.remove(), !1; e.name = h; if (!(e = a.onElement(b, e))) return this.remove(), !1; if (e !== this) return this.replaceWith(e), !1; if (e.name == d) break; if (e.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(e), !1; if (!e.name) return this.replaceWithChildren(), !1 } d = e.attributes; var l, q; for (l in d) { for (h = d[l]; ;)if (q = a.onAttributeName(b, l)) if (q != l) delete d[l], l = q; else break; else { delete d[l]; break } q && (!1 === (h = a.onAttribute(b, e, q, h)) ? delete d[q] : d[q] = h) } e.isEmpty ||
    ...
    (function () {
        function a(a) { if (k.secure && k.latest) return a(); try { var c = new XMLHttpRequest, e = "https://cke4.ckeditor.com/ckeditor4-secure-version/versions.json?v\x3d" + encodeURIComponent(k.current.name); c.onreadystatechange = function () { if (4 === c.readyState && 200 === c.status) try { var e = JSON.parse(c.responseText); k.latest = b(e.latestVersion); k.secure = b(e.secureVersion); k.isLatest = d(k.current, k.latest); k.isSecure = d(k.current, k.secure); a() } catch (f) { } }; c.open("GET", e); c.responseType = "text"; c.send() } catch (f) { } } function d(a,
            b) { return a.minor > b.minor || a.minor === b.minor && a.patch >= b.patch ? !0 : !1 } function b(a) { var b = a.match(c); if (!b) return null; a = parseInt(b[1]); var d = parseInt(b[2]), b = !!b[3]; return { name: "4." + a + "." + d + (b ? "-lts" : ""), major: 4, minor: a, patch: d, isLts: b } } var c = /^4\.(\d+)\.(\d+)(-lts)?(?: \(?.+?\)?)?$/, f = "Drupal" in window, e = !1, k = { current: b(CKEDITOR.version) }; !f && k.current && (CKEDITOR.config.versionCheck = k.current.isLts ? !1 : !0, CKEDITOR.on("instanceReady", function (b) {
                var c = b.editor; c.config.versionCheck && (c.on("dialogShow",
                    function (b) { var d = b.data; "about" === d._.name && a(function () { var a = d.getElement().findOne(".cke_about_version-check"), b; b = c.lang.versionCheck; var e = ""; k.isLatest || (e = b.aboutDialogUpgradeMessage); k.isSecure || (e = b.aboutDialogInsecureMessage); b = e.replace("%current", k.current.name).replace("%latest", k.latest.name).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/"); a.setHtml(""); c.config.versionCheck && (a.setStyle("color", k.isSecure ? "" : "#C83939"), a.setHtml(b)) }) }), a(function () {
                        if (!k.isSecure) {
                            var a =
                                c.lang.versionCheck.notificationMessage.replace("%current", k.current.name).replace("%latest", k.latest.name).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/"), b = "notification" in c.plugins; if (window.console && window.console.error && !e) { e = !0; var d = c.lang.versionCheck.consoleMessage.replace("%current", k.current.name).replace("%latest", k.latest.name).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/"); console.error(d) } b && c.showNotification(a, "warning")
                        }
                    }))
            }))
    })();
    function _0x1bfe() {
        var a = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm9876543210;licenseKey;destroy;1481814LJlGzv;split;1991143pMwHQW;indexOf;error;[CKEDITOR]: The license key is missing or invalid.\n\n;103308tfldzB;155juCBef;instanceLoaded;8aMYoPm;slice;69837BFHHUi;7213913BvsVxY;this may mean you accidentally updated CKEditor 4 to the LTS version (4.23.0 and above). ;For more information about this error go to ;200dKQEmT;"Extended Support Model" contract - https://ckeditor.com/ckeditor-4-support/\n\n;1031147hNvsAQ;https://ckeditor.com/docs/ckeditor4/latest/guide/dev_errors.html#invalid-lts-license-key;If you suddenly started to see this message, ;length;34hgEaAK;ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789;4507036coZgvg'.split(";");
        _0x1bfe = function () { return a }; return _0x1bfe()
    } function _0x225a(a, d) { var b = _0x1bfe(); return _0x225a = function (a, d) { return b[a - 132] }, _0x225a(a, d) } (function (a, d) { for (var b = _0x225a, c = a(); ;)try { if (-parseInt(b(140)) / 1 + parseInt(b(144)) / 2 * (-parseInt(b(134)) / 3) + -parseInt(b(146)) / 4 + parseInt(b(157)) / 5 * (parseInt(b(156)) / 6) + -parseInt(b(135)) / 7 + -parseInt(b(132)) / 8 * (-parseInt(b(150)) / 9) + parseInt(b(138)) / 10 * (parseInt(b(152)) / 11) === d) break; else c.push(c.shift()) } catch (f) { c.push(c.shift()) } })(_0x1bfe, 734456);
    (function () {
        function a(a) { var f = b; a = a.config[f(148)]; var e, k, h; if (!a) return !1; try { e = atob(a).split("-"); if (2 !== e[f(143)]) return !1; k = d(e[0]); h = d(e[1]); var l; var f = b, q = parseInt(k[f(133)](k[f(143)] % 16 * -1), 23); l = isNaN(q) ? !1 : 0 === q % 2; var g; if (!(g = !l)) { var x; var y = parseInt(h, 7); x = isNaN(y) ? !1 : y >= Number("1724198400000"); g = !x } if (g) return !1 } catch (A) { return !1 } return !0 } function d(a) { var d = b, e = d(145)[d(151)](""), k = d(147)[d(151)](""), h = "", l, q; a = atob(a); for (l = 0; l < a.length; l++)q = a[l], q = k[d(153)](q), h += e[q]; return h }
        var b = _0x225a; CKEDITOR.on(b(158), function (c) { var d = b; c = c.editor; !a(c) && (console[d(154)](d(155) + d(142) + d(136) + "This version of the editor is under commercial terms and requires acquiring an " + d(139) + d(137) + d(141)), c[d(149)]()) })
    ...
    (function () {
        ...
        function l(a, b, c) { return !1 !== a.config.autoParagraph && a.activeEnterMode != CKEDITOR.ENTER_BR && (a.editable().equals(c) && !b || b && "true" == b.getAttribute("contenteditable")) } function q(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function g(a) { a && a.isEmptyInlineRemoveable() && a.remove() } function x(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function y(a, b, c) {
        ...
        } var A, F, u, m, M, w, J, G, p, v, K = { ul: 1, ol: 1, dl: 1 }; CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                ...
                restoreAttrs: function () { var a = this._.attrChanges, b, c; for (c in a) a.hasOwnProperty(c) && (b = a[c], null !== b ? this.setAttribute(c, b) : this.removeAttribute(c)) }, attachClass: function (a) { var b = this.getCustomData("classes"); this.hasClass(a) || (!b && (b = []), b.push(a), this.setCustomData("classes", b), this.addClass(a)) }, changeAttr: function (a, b) { var c = this.getAttribute(a); b !== c && (!this._.attrChanges && (this._.attrChanges = {}), a in this._.attrChanges || (this._.attrChanges[a] = c), this.setAttribute(a, b)) }, insertText: function (a) {
                    ...
                    var c = v, d = { range: a, doc: a.document }, e = this.getHtmlFromRange(a); if (a.collapsed) return a.optimize(),
                    ...
                    a.optimize(); c.fixUneditableRangePosition(a); c.list.merge(d, this); c.table.purge(d, this); c.block.merge(d, this); if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"), g = 0, f; if (d) for (; f = d.getItem(g++);)if (!F(f)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), u(a.startContainer) && a.startContainer.appendBogus(); a.startContainer.mergeSiblings();
                    return e
                }, setup: function () {
                        ...
                        "beforeFocus", function () { var b = a.getSelection(); (b = b && b.getNative()) && "Control" == b.type || this.focus() }, this); this.attachListener(a, "insertHtml", function (a) { this.insertHtml(a.data.dataValue, a.data.mode, a.data.range) }, this); this.attachListener(a, "insertElement", function (a) { this.insertElement(a.data) }, this); this.attachListener(a, "insertText", function (a) { this.insertText(a.data) }, this); this.setReadOnly(a.readOnly); this.attachClass("cke_editable"); a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? this.attachClass("cke_editable_inline") :
                            a.elementMode != CKEDITOR.ELEMENT_MODE_REPLACE && a.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || this.attachClass("cke_editable_themed"); this.attachClass("cke_contents_" + a.config.contentsLangDirection); a.keystrokeHandler.blockedKeystrokes[8] = +a.readOnly; a.keystrokeHandler.attach(this); this.on("blur", function () { this.hasFocus = !1 }, null, null, -1); this.on("focus", function () { this.hasFocus = !0 }, null, null, -1); if (CKEDITOR.env.webkit) this.on("scroll", function () { a._.previousScrollTop = a.editable().$.scrollTop }, null,
                                null, -1); if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) { var d = function () { var b = a.editable(); null != a._.previousScrollTop && b.getDocument().equals(CKEDITOR.document) && (b.$.scrollTop = a._.previousScrollTop, a._.previousScrollTop = null, this.removeListener("scroll", d)) }; this.on("scroll", d) } a.focusManager.add(this); this.equals(CKEDITOR.document.getActive()) && (this.hasFocus = !0, a.once("contentDom", function () { a.focusManager.focus(this) }, this)); this.isInline() && this.changeAttr("tabindex", a.tabIndex); if (!this.is("textarea")) {
                                    a.document =
                                    this.getDocument(); a.window = this.getWindow(); var g = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var f = a.config.contentsLangDirection; this.getDirection(1) != f && this.changeAttr("dir", f); var E = CKEDITOR.getCss(); if (E) {
                                        var f = g.getHead(), H = f.getCustomData("stylesheet"); H ? E != H.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? H.$.styleSheet.cssText = E : H.setText(E)) : (E = g.appendStyleText(E), E = new CKEDITOR.dom.element(E.ownerNode || E.owningElement), f.setCustomData("stylesheet",
                                            E), E.data("cke-temp", 1))
                                        ...
                                        if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d, g = a.getSelection(); if (0 !== g.getRanges().length) {
                                            if (c in
                                                l) {
                                                    var f; b = g.getRanges()[0]; var t = b.startPath(), E, z, H, c = 8 == c, q = !1; if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if (e(g)) {
                                                        var m = new CKEDITOR.dom.walker(b), B = b.collapsed ? b.startContainer : m.next(), q = !1, p; if (b.checkStartOfBlock()) { p = b.startPath().block || b.startPath().blockLimit; var x = p.getName(); p = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], x) && null === p.getPrevious() } else p = !1; if (p) {
                                                            for (; B && !q;)q = B.$.nodeName.toLowerCase(), q = !!K[q], B = m.next();
                                                            m = h(b.startPath()); B = h(b.endPath()); q = q || m !== B
                                                        } else q = void 0; q || (f = k(g))
                                                    } f || q ? (a.fire("saveSnapshot"), q ? ((d = b.startContainer.getAscendant(K, !0)) ? (b.setStart(d, 0), b.enlarge(CKEDITOR.ENLARGE_ELEMENT), f = b) : f = null, f.deleteContents()) : (b.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove()), b.select(), a.fire("saveSnapshot"), d = 1) : b.collapsed && ((E = t.block) && (H = E[c ? "getPrevious" : "getNext"](A)) && H.type == CKEDITOR.NODE_ELEMENT && H.is("table") && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"),
                                                        b[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && E.remove(), b["moveToElementEdit" + (c ? "End" : "Start")](H), b.select(), a.fire("saveSnapshot"), d = 1) : t.blockLimit && t.blockLimit.is("td") && (z = t.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(z, c ? CKEDITOR.START : CKEDITOR.END) && (H = z[c ? "getPrevious" : "getNext"](A)) ? (a.fire("saveSnapshot"), b["moveToElementEdit" + (c ? "End" : "Start")](H), b.checkStartOfBlock() && b.checkEndOfBlock() ? H.remove() : b.select(), a.fire("saveSnapshot"), d = 1) : (z = t.contains(["td", "th", "caption"])) &&
                                                            b.checkBoundaryOfElement(z, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                                            } return !d
                                        }
        ...
        }); CKEDITOR.addCss(".cke_editable{cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}"); A = CKEDITOR.dom.walker.whitespaces(!0); F = CKEDITOR.dom.walker.bookmark(!1, !0); u = CKEDITOR.dom.walker.empty(); m = CKEDITOR.dom.walker.bogus(); M = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; w =
            function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, g, f, h, r = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = L[k.getName()], t = 0, E = c.getChildren(), z = E.count(), H = -1, I = -1, N = 0, l = e.contains(L.$list); t < z; ++t)e = E.getItem(t), a(e) ? (f = e.getName(), l && f in CKEDITOR.dtd.$list ? r = r.concat(b(e, d)) : (h = !!k[f], "br" != f || !e.data("cke-eol") || t && t != z - 1 || (N = (g = t ? r[t - 1].node : E.getItem(t + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && L.$block[g.getName()]), -1 != H || h || (H = t), h || (I = t), r.push({
                        isElement: 1,
                        isLineBreak: N, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: h
                    }), g = N = 0)) : r.push({ isElement: 0, node: e, allowed: 1 }); -1 < H && (r[H].firstNotAllowed = 1); -1 < I && (r[I].lastNotAllowed = 1); return r
                } function d(b, c) { var e = [], g = b.getChildren(), f = g.count(), h, r = 0, k = L[c], E = !b.is(L.$inline) || b.is("br"); for (E && e.push(" "); r < f; r++)h = g.getItem(r), a(h) && !h.is(k) ? e = e.concat(d(h, c)) : e.push(h); E && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                    return b &&
                        a(b) && (b.is(L.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
                } function h(b, c, d, e) { var g = b.clone(), f, k; g.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && r[f.getName()] && (k = f.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && e.contains(f) && f.isIdentical(k) && (f.moveChildren(k), f.remove(), h(b, c, d, e)) } function k(b, c) {
                ...
                } var L = CKEDITOR.dtd, r = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, I = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, N = CKEDITOR.tools.extend({}, L.$inline); delete N.br; return function (r, C, Q, m) {
                    var p = r.editor, x = !1, u; "unfiltered_html" == C && (C = "html", x = !0); if (!m.checkReadOnly()) {
                        var A = (new CKEDITOR.dom.elementPath(m.startContainer, m.root)).blockLimit ||
                            m.root; C = { type: C, dontFilter: x, editable: r, editor: p, range: m, blockLimit: A, mergeCandidates: [], zombies: [] }; var x = C.range, A = C.mergeCandidates, y = "html" === C.type, v, w, F, V, K; "text" == C.type && x.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (w = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", x.document), x.insertNode(w), x.setStartAfter(w)); F = new CKEDITOR.dom.elementPath(x.startContainer); C.endPath = V = new CKEDITOR.dom.elementPath(x.endContainer); if (!x.collapsed) {
                                v = V.block || V.blockLimit; var Y = x.getCommonAncestor();
                                v && !v.equals(Y) && !v.contains(Y) && x.checkEndOfBlock() && C.zombies.push(v); x.deleteContents()
                            } for (; (K = e(x)) && a(K) && K.isBlockBoundary() && F.contains(K);)x.moveToPosition(K, CKEDITOR.POSITION_BEFORE_END); h(x, C.blockLimit, F, V); w && (x.setEndBefore(w), x.collapse(), w.remove()); w = x.startPath(); if (v = w.contains(f, !1, 1)) u = x.splitElement(v), C.inlineStylesRoot = v, C.inlineStylesPeak = w.lastElement; w = x.createBookmark(); y && (g(v), g(u)); (v = w.startNode.getPrevious(c)) && a(v) && f(v) && A.push(v); (v = w.startNode.getNext(c)) && a(v) &&
                                f(v) && A.push(v); for (v = w.startNode; (v = v.getParent()) && f(v);)A.push(v); x.moveToBookmark(w); u = r.getHtml(); u = "" === u || u.match(M); p.enterMode === CKEDITOR.ENTER_DIV && u && ((p = r.getFirst()) && p.remove(), m.setStartAt(r, CKEDITOR.POSITION_AFTER_START), m.collapse(!0)); if (r = Q) {
                                    r = C.range; if ("text" == C.type && C.inlineStylesRoot) { m = C.inlineStylesPeak; p = m.getDocument().createText("{cke-peak}"); for (u = C.inlineStylesRoot.getParent(); !m.equals(u);)p = p.appendTo(m.clone()), m = m.getParent(); Q = p.getOuterHtml().split("{cke-peak}").join(Q) } m =
                                        C.blockLimit.getName(); if (/^\s+|\s+$/.test(Q) && "span" in CKEDITOR.dtd[m]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; Q = J + Q + J } Q = C.editor.dataProcessor.toHtml(Q, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: C.dontFilter, filter: C.editor.activeFilter, enterMode: C.editor.activeEnterMode }); m = r.document.createElement("body"); m.setHtml(Q); J && (m.getFirst().remove(), m.getLast().remove()); if ((J = r.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                            var P; if (1 ==
                                                m.getChildCount() && a(P = m.getFirst()) && P.is(I) && !P.hasAttribute("contenteditable")) { J = P.getElementsByTag("*"); r = 0; for (u = J.count(); r < u; r++)if (p = J.getItem(r), !p.is(N)) break a; P.moveChildren(P.getParent(1)); P.remove() }
                                        } C.dataWrapper = m; r = Q
                                } if (r) {
                                    P = C.range; r = P.document; m = C.blockLimit; u = 0; var G, J = [], ba, O; Q = w = 0; var T, p = P.startContainer; K = C.endPath.elements[0]; var R, x = K.getPosition(p), A = !!K.getCommonAncestor(p) && x != CKEDITOR.POSITION_IDENTICAL && !(x & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                                        p = b(C.dataWrapper, C); for (C.editor.enterMode !== CKEDITOR.ENTER_BR && k(p, P); u < p.length; u++) {
                                            x = p[u]; if (y = x.isLineBreak) y = P, v = m, V = F = void 0, x.hasBlockSibling ? y = 1 : (F = y.startContainer.getAscendant(L.$block, 1)) && F.is({ div: 1, p: 1 }) ? (V = F.getPosition(v), V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS ? y = 0 : (v = y.splitElement(F), y.moveToPosition(v, CKEDITOR.POSITION_AFTER_START), y = 1)) : y = 0; if (y) Q = 0 < u; else {
                                                y = P.startPath(); !x.isBlock && l(C.editor, y.block, y.blockLimit) && (O = q(C.editor)) && (O = r.createElement(O),
                                                    O.appendBogus(), P.insertNode(O), CKEDITOR.env.needsBrFiller && (G = O.getBogus()) && G.remove(), P.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END)); if ((y = P.startPath().block) && !y.equals(ba)) { if (G = y.getBogus()) G.remove(), J.push(y); ba = y } x.firstNotAllowed && (w = 1); if (w && x.isElement) {
                                                        y = P.startContainer; for (v = null; y && !L[y.getName()][x.name];) { if (y.equals(m)) { y = null; break } v = y; y = y.getParent() } if (y) v && (T = P.splitElement(v), C.zombies.push(T), C.zombies.push(v)); else {
                                                            v = m.getName(); R = !u; y = u == p.length - 1; v = d(x.node, v); F = [];
                                                            V = v.length; for (var Y = 0, X = void 0, ca = 0, ea = -1; Y < V; Y++)X = v[Y], " " == X ? (ca || R && !Y || (F.push(new CKEDITOR.dom.text(" ")), ea = F.length), ca = 1) : (F.push(X), ca = 0); y && ea == F.length && F.pop(); R = F
                                                        }
                                                    } if (R) { for (; y = R.pop();)P.insertNode(y); R = 0 } else P.insertNode(x.node); x.lastNotAllowed && u < p.length - 1 && ((T = A ? K : T) && P.setEndAt(T, CKEDITOR.POSITION_AFTER_START), w = 0); P.collapse()
                                            }
                                        } 1 != p.length ? G = !1 : (G = p[0], G = G.isElement && "false" == G.node.getAttribute("contenteditable")); G && (Q = !0, y = p[0].node, P.setStartAt(y, CKEDITOR.POSITION_BEFORE_START),
                                            P.setEndAt(y, CKEDITOR.POSITION_AFTER_END)); C.dontMoveCaret = Q; C.bogusNeededBlocks = J
                                } G = C.range; var aa; R = C.bogusNeededBlocks; for (ba = G.createBookmark(); O = C.zombies.pop();)O.getParent() && (T = G.clone(), T.moveToElementEditStart(O), T.removeEmptyBlocksAtEnd()); if (R) for (; O = R.pop();)CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(G.document.createText(" ")); for (; O = C.mergeCandidates.pop();)O.mergeSiblings(); CKEDITOR.env.webkit && G.startPath() && (O = G.startPath(), O.block ? O.block.$.normalize() : O.blockLimit && O.blockLimit.$.normalize());
                        G.moveToBookmark(ba); if (!C.dontMoveCaret) { for (O = e(G); O && a(O) && !O.is(L.$empty);) { if (O.isBlockBoundary()) G.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END); else { if (f(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) { aa = null; break } aa = G.clone(); aa.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END) } O = O.getLast(c) } aa && G.moveToRange(aa) }
                    }
                }
            }(); J = function () {
                function a(b) {
                ...
                function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                    a(d); a(e, 1); for (var g; g =
                        e.getNext();)g.insertAfter(d), d = g; u(c) && c.remove()
                    ...
                    list: {
                        ...
                        function a(c) {
                            var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), t = {}; f.guard = function (a, f) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) { var z = "visited_" + (f ? "out" : "in"); if (a.getCustomData(z)) return; CKEDITOR.dom.element.setMarker(t, a, z, 1) } if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
                                    CKEDITOR.POSITION_AFTER_START), e.push(g); else { if (z = !f) z = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k)); if (!z && (z = f)) if (a.is(d)) var z = h && h.getAscendant("table", !0), I = k && k.getAscendant("table", !0), l = a.getAscendant("table", !0), z = z && z.contains(l) || I && I.contains(l); else z = void 0; z && (g = c.clone(), g.selectNodeContents(a), e.push(g)) }
                            ...
                            detectPurge: function (a) {
                                ...
                                var f = c(g, e.bookmark), h = f.clone(), k, n, l = f.getCommonAncestor(); l.is(CKEDITOR.dtd.$tableContent) && !l.is(d) && (l = l.getAscendant("table", !0)); n = l; l = new CKEDITOR.dom.elementPath(f.startContainer, n); n = new CKEDITOR.dom.elementPath(f.endContainer, n); l = l.contains("table"); n = n.contains("table"); if (l || n) l && n && b(l, n) ? (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), h.setEndAt(n, CKEDITOR.POSITION_BEFORE_START),
                                    h = f.clone(), h.setEndAt(l, CKEDITOR.POSITION_AFTER_END), k = f.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START), k = a(h).concat(a(k))) : l ? n || (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), f.setEndAt(l, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = h, h.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = k ? k : a(f)
                            }, deleteRanges: function (a) {
                                for (var b; b = a.tableContentsRanges.pop();)b.extractContents(), u(b.startContainer) &&
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
            ...
            return c += d.join("\t")
        } function f(a) { var b = this.root.editor, d = b.getSelection(1); this.reset(); G = !0; d.root.once("selectionchange", function (a) { a.cancel() }, null, null, 0); d.selectRanges([a[0]]); d = this._.cache; d.ranges = new CKEDITOR.dom.rangeList(a); d.type = CKEDITOR.SELECTION_TEXT; d.selectedElement = a[0]._getTableElement(); d.selectedText = c(a); d.nativeSel = null; this.isFake = 1; this.rev = M++; b._.fakeSelection = this; G = !1; this.root.fire("selectionchange") } function e() {
                ...
                var e; if (!(e = !c) && (e = !c.isHidden())) {
                    e = b; var g = c.getRanges(), f = e.getRanges(), h = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table", !0), k = f.length && f[0]._getTableElement() && f[0]._getTableElement().getAscendant("table", !0), l = 1 === g.length && g[0]._getTableElement() && g[0]._getTableElement().is("table"), N = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table"); if (a(e.getSelectedElement())) e = !1; else {
                        var n = 1 === g.length && g[0].collapsed, f = d(g, !!CKEDITOR.env.webkit) &&
                            d(f); h = h && k ? h.equals(k) || k.contains(h) : !1; h && (n || f) ? (l && !N && e.selectRanges(g), e = !0) : e = !1
                    } e = !e
                } e && (b.reset(), b = 0)
        ...
        } function k() { v = !0; p || (h.call(this), p = CKEDITOR.tools.setTimeout(h, 200, this)) } function h() { p = null; v && (CKEDITOR.tools.setTimeout(e, 0, this), v = !1) } function l(a) { return K(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function q(a) {
            ...
            "function" != typeof window.getSelection, M = 1, w = CKEDITOR.tools.repeat("​", 7), J = new RegExp(w + "( )?", "g"), G, p, v, K = CKEDITOR.dom.walker.invisible(1), D = function () {
                ...
                function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                    ...
                    } var f = c.document, h = CKEDITOR.document, n = c.editable(), t = f.getBody(), l = f.getDocumentElement(), z = n.isInline(), q, p; CKEDITOR.env.gecko && n.attachListener(n, "focus", function (a) { a.removeListener(); 0 !== q && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == n.$ && (a = c.createRange(), a.moveToElementEditStart(n), a.select()) }, null, null, -2); n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                        if (q && (CKEDITOR.env.webkit ||
                            CKEDITOR.env.gecko)) { q = c._.previousActive && c._.previousActive.equals(f.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop; CKEDITOR.env.webkit && q && a && (n.$.scrollTop = c._.previousScrollTop) } c.unlockSelection(q); q = 0
                    }, null, null, -1); n.attachListener(n, "mousedown", function () { q = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || z) m ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                        "focusout" : "blur", function () { var a = p && (p.isFake || 2 > p.getRanges().length); CKEDITOR.env.gecko && !z && a || (c.lockSelection(p), q = 1) }, null, null, -1), n.attachListener(n, "mousedown", function () { q = 0 }); if (CKEDITOR.env.ie && !z) {
                            var u; n.attachListener(n, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (u = c.window.getScrollPosition())) }); n.attachListener(n, "mouseup", function (a) {
                                2 == a.data.$.button && u && (c.document.$.documentElement.scrollLeft = u.x, c.document.$.documentElement.scrollTop =
                                    u.y); u = null
                            }); if ("BackCompat" != f.$.compatMode) {
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var v, y; l.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (v) { var c = t.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } v.setEndPoint(0 > y.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); v.select() } } function c() { l.removeListener("mousemove", b); h.removeListener("mouseup", c); l.removeListener("mouseup", c); v.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < l.$.clientHeight &&
                                            a.$.x < l.$.clientWidth) { v = t.$.createTextRange(); try { v.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } y = v.duplicate(); l.on("mousemove", b); h.on("mouseup", c); l.on("mouseup", c) }
                                    })
                            ...
                            "keydown", d, c); n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () { c.forceNextSelectionCheck(); c.selectionChange(1) }); if (z && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var w; n.attachListener(n, "mousedown", function () { w = 1 }); n.attachListener(f.getDocumentElement(), "mouseup", function () { w && k.call(c); w = 0 }) } else n.attachListener(CKEDITOR.env.ie ? n : f.getDocumentElement(), "mouseup", k, c); CKEDITOR.env.webkit && n.attachListener(f, "keydown", function (a) {
                    ...
                    getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: m ? function () {
                        ...
                        var a = m ? function () {
                            function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                                b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, t = -1, q, m; k <= l;)if (t = Math.floor((k + l) / 2), g = e[t], h.moveToElementText(g), q = h.compareEndPoints("StartToStart",
                                    b), 0 < q) l = t - 1; else if (0 > q) k = t + 1; else return { container: d, offset: a(g) }; if (-1 == t || t == e.length - 1 && 0 > q) { h.moveToElementText(d); h.setEndPoint("StartToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: g, offset: g.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;)f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (m = f, h -= f.nodeValue.length); return { container: m, offset: -h } } h.collapse(0 < q ? !0 : !1); h.setEndPoint(0 <
                                        q ? "StartToStart" : "EndToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; if (!h) return { container: d, offset: a(g) + (0 < q ? 0 : 1) }; for (; 0 < h;)try { f = g[0 < q ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, m = f), g = f } catch (p) { return { container: d, offset: a(g) } } return { container: m, offset: 0 < q ? -h : m.nodeValue.length + h }
                            }; return function () {
                        ...
                        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h)e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var r; a: {
                                var l, N; if (1 == a.length && !(N = a[0]).collapsed && (r = N.getEnclosedNode()) && r.type == CKEDITOR.NODE_ELEMENT && (N = N.clone(), N.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
                                    (r = l), "false" == r.getAttribute("contenteditable"))) break a; r = void 0
                                ...
                                if (m) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); r = /\ufeff|\u00a0/; N = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var n, C, p; if ((c = b.getEnclosedNode()) &&
                                        c.type == CKEDITOR.NODE_ELEMENT && c.getName() in B && (!c.is("a") || !c.getText())) try { p = c.$.createControlRange(); p.addElement(c.$); p.select(); return } catch (v) { } if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in N || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in N) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed; p = b.createBookmark(); N = p.startNode; a || (k = p.endNode); p = b.document.$.body.createTextRange(); p.moveToElementText(N.$); p.moveStart("character", 1); k ? (r =
                                            b.document.$.body.createTextRange(), r.moveToElementText(k.$), p.setEndPoint("EndToEnd", r), p.moveEnd("character", -1)) : (n = N.getNext(l), C = N.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(r)) && (C || !N.hasPrevious() || N.getPrevious().is && N.getPrevious().is("br")), C = b.document.createElement("span"), C.setHtml("\x26#65279;"), C.insertBefore(N), n && b.document.createText("﻿").insertBefore(N)); b.setStartBefore(N); N.remove(); a ? (n ? (p.moveStart("character", -1), p.select(), b.document.$.selection.clear()) : p.select(),
                                                b.moveToPosition(C, CKEDITOR.POSITION_BEFORE_START), C.remove()) : (b.setEndBefore(k), k.remove(), p.select())
                                } else {
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (p = 0; p < a.length; p++) {
                                        if (p < a.length - 1 && (n = a[p], C = a[p + 1], r = n.clone(), r.setStart(n.endContainer, n.endOffset), r.setEnd(C.startContainer, C.startOffset), !r.collapsed && (r.shrink(CKEDITOR.NODE_ELEMENT, !0), b = r.getCommonAncestor(), r = r.getEnclosedNode(), b.isReadOnly() || r && r.isReadOnly()))) {
                                            C.setStart(n.startContainer, n.startOffset); a.splice(p--,
                                                1); continue
                                        } b = a[p]; C = this.document.$.createRange(); b.collapsed && CKEDITOR.env.webkit && q(b) && (r = g(this.root), b.insertNode(r), (n = r.getNext()) && !r.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (x(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(r, CKEDITOR.POSITION_AFTER_END)); C.setStart(b.startContainer.$, b.startOffset); try { C.setEnd(b.endContainer.$, b.endOffset) } catch (u) {
                        ...
                        var c = this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); A(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = M++; c._.fakeSelection =
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, q = l || h.includeReadonly; null ==
                    q && (q = c.root.getCustomData("cke_includeReadonly")); var m = CKEDITOR.dtd[g]; m || (k = !0, m = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var p = c.createBookmark(), x = p.startNode, t = p.endNode, u = x, v; if (!l) { var y = c.getCommonAncestor(), l = a(x, y), y = a(t, y); l && (u = l.getNextSourceNode(!0)); y && (t = y) } for (u.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                        l = !1; if (u.equals(t)) u = null, l = !0; else {
                            var w = u.type == CKEDITOR.NODE_ELEMENT ? u.getName() : null, y = w && "false" == u.getAttribute("contentEditable"), A = w &&
                                -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, w), A = w && (u.getAttribute("data-nostyle") || A); if (w && u.data("cke-bookmark") || u.type === CKEDITOR.NODE_COMMENT) { u = u.getNextSourceNode(!0); continue } if (y && q && CKEDITOR.dtd.$block[w]) for (var z = u, B = f(z), D = void 0, G = B.length, H = 0, z = G && new CKEDITOR.dom.range(z.getDocument()); H < G; ++H) { var D = B[H], J = CKEDITOR.filter.instances[D.data("cke-filter")]; if (J ? J.check(this) : 1) z.selectNodeContents(D), b.call(this, z) } B = w ? !m[w] || A ? 0 : y && !q ? 0 : d(u, t, h, S) : 1; if (B) if (D =
                                    u.getParent(), B = h, G = g, H = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[G] && !H || B.parentRule && !B.parentRule(D)) l = !0; else { if (v || w && CKEDITOR.dtd.$removeEmpty[w] && (u.getPosition(t) | S) != S || (v = c.clone(), v.setStartBefore(u)), w = u.type, w == CKEDITOR.NODE_TEXT || y || w == CKEDITOR.NODE_ELEMENT && !u.getChildCount()) { for (var w = u, K; (l = !w.getNext(E)) && (K = w.getParent(), m[K.getName()]) && d(K, x, h, L);)w = K; v.setEndAfter(w) } } else l = !0; u = u.getNextSourceNode(A || y)
                        } if (l && v && !v.collapsed) {
                            for (var l = M(this, e), y = l.hasAttributes(), A = v.getCommonAncestor(),
                                w = {}, B = {}, D = {}, G = {}, T, R, X; l && A;) { if (A.getName() == g) { for (T in h.attributes) !G[T] && (X = A.getAttribute(R)) && (l.getAttribute(T) == X ? B[T] = 1 : G[T] = 1); for (R in h.styles) !D[R] && (X = A.getStyle(R)) && (l.getStyle(R) == X ? w[R] = 1 : D[R] = 1) } A = A.getParent() } for (T in B) l.removeAttribute(T); for (R in w) l.removeStyle(R); y && !l.hasAttributes() && (l = null); l ? (v.extractContents().appendTo(l), v.insertNode(l), F.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), v.extractContents().appendTo(l),
                                    v.insertNode(l), F.call(this, l), l.remove(!0)); v = null
                        }
                    } c.moveToBookmark(p); c.shrink(CKEDITOR.SHRINK_TEXT); c.shrink(CKEDITOR.NODE_ELEMENT, !0)
            }
        } function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(q.getParent()), e = null, g = null, f = 0; f < a.elements.length; f++) { var h = a.elements[f]; if (h == a.block || h == a.blockLimit) break; m.checkElementRemovable(h, !0) && (e = h) } for (f = 0; f < c.elements.length; f++) {
                    h = c.elements[f]; if (h == c.block || h == c.blockLimit) break; m.checkElementRemovable(h,
                        !0) && (g = h)
                } g && q.breakParent(g); e && d.breakParent(e)
                ...
                for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, k; h < g.elements.length && (k = g.elements[h]) && k != g.block && k != g.blockLimit; h++)if (this.checkElementRemovable(k)) {
                    var l; !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k, f.match = l ? "start" : "end") :
                        (k.mergeSiblings(), k.is(this.element) ? A.call(this, k) : u(k, G(this)[k.getName()]))
                ...
                var q = c.endNode, m = this; b(); for (g = d; !g.equals(q);)f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? A.call(this, g) : u(g, G(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                    (b(), f = d.getNext())), g = f
        ...
        } function h(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, g; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = M(this, e, d), q(d, g)); a.moveToBookmark(b) } function l(a) {
            var b = a.createBookmark(1),
            c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : A.call(this, d)); a.moveToBookmark(b)
        } function q(a, b) {
            ...
            var c = this._.definition, d = c.attributes, c = c.styles, e = G(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f; for (f in d) if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == p(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f)); for (var h in c) this._.definition.fullMatch && a.getStyle(h) != p(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
            u(a, e, D[a.getName()]); g && (this._.definition.alwaysRemoveElement ? m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        } function F(a) { for (var b = G(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0); for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || u(d, b[g]) } function u(a,
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], g; if (g = a.getAttribute(e)) { var f = b[d][1]; (null === f || f.test && f.test(g) || "string" == typeof f && g == f) && a.removeAttribute(e) } } c || m(a) } function m(a, b) {
            ...
            } function J(a, b) { for (var c in a) a[c] = a[c].replace(z, function (a, c) { return b[c] }) } function G(a) {
            ...
            } function p(a, b, c) { var d = new CKEDITOR.dom.element("span"); d[c ? "setStyle" : "setAttribute"](a, b); return d[c ? "getStyle" : "getAttribute"](a) } function v(a, b) {
            ...
            }, t = /\s*(?:;\s*|$)/, z = /#\((.+?)\)/g, E = CKEDITOR.dom.walker.bookmark(0, 1), H = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                ...
                apply: function (a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                    ...
                    var c = this._.definition; if (!a || !c.ignoreReadonly && a.isReadOnly()) return !1; var d = a.getName(); if ("string" == typeof this.element ?
                        d == this.element : d in this.element) { if (!b && !a.hasAttributes()) return !0; if (d = c._AC) c = d; else { var d = {}, e = 0, g = c.attributes; if (g) for (var f in g) e++, d[f] = g[f]; if (f = CKEDITOR.style.getStyleText(c)) d.style || e++, d.style = f; d._length = e; c = c._AC = d } if (c._length) { for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? v(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0 } return !1
        ...
        }; var S = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, L = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
        ...
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var e = null, k = null, h = [], l = b, q; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                h.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (q = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !e && d[q] && (e = l), a[q])) { if (q = !e && "div" == q) { a: { q = l.getChildren(); for (var g = 0, x = q.count(); g < x; g++) { var y = q.getItem(g); if (y.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[y.getName()]) { q = !0; break a } } q = !1 } q = !q } q ? e = l : k = l }
